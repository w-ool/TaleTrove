...
nw_url = 'https://toptoon.com/complete#complete4'
...
# 작품 카테고리 띄우기
button = driver.find_element_by_xpath('/html/body/div[5]/div/div/div/div/ul[4]/div/div/div')
button.click()

# 카테고리중 전체 클릭
show_all = driver.find_element_by_xpath('/html/body/div[5]/div/div/div/div/ul[4]/div/div/ul/li[8]')
show_all.click()

for i in range(600):
    try:
        sleep(random.uniform(1,1.5))
        title = driver.find_element_by_xpath(f'/html/body/div[5]/div/div/div/div/ul[4]/li[{i+1}]/a')
...
webtoon_data.to_csv('./crawling_data/toptoon_finished.csv', encoding='utf-8-sig')