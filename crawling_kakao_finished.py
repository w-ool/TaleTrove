...
kw_url = 'https://page.kakao.com/menu/10010/screen/52?tab_uid=12'
...
for j in range(300):
    try:
        ...
        if (j+1) % 25 == 0:
            ...
            print('wait')
        try:
            title = driver.find_element_by_xpath(f'/html/body/div/div/div[2]/div/div[2]/div[1]/div/div[4]/div/div/div[{j+1}]/div/a')
            print(title)
            title.click()
        except:
            for a in range(1):
        ...
        try:
            # 제목, 줄거리, 장르, 작가명
            name = driver.find_element_by_xpath(f'/html/body/div[1]/div/div[2]/div[1]/div[1]/div[1]/div[1]/div/div[3]/div[2]/span').text
            # / html / body / div[1] / div / div[2] / div[1] / div[1] / div[1] / div[1] / div / div[3] / div[2] / span
            story_see = driver.find_element_by_xpath(f'/html/body/div[1]/div/div[2]/div[1]/div[2]/div[1]/div/div/div[2]/a/div')
            story_see.click()   # 웹툰 작품소개 페이지 이동
            sleep(random.uniform(1, 1.5))
            num = 3
            try:
                story = driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div[1]/div[2]/div[2]/div[3]/span').text
            # / html / body / div[1] / div / div[2] / div[1] / div[2] / div[2] / div[3] / span
            # / html / body / div[1] / div / div[2] / div[1] / div[2] / div[2] / div[1] / span
            except:
                story = driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div[1]/div[2]/div[2]/div[1]/span').text

            genre = driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div[1]/div[1]/div[1]/div[1]/div/div[3]/div[2]/div[1]/div[1]/span[4]').text
...
webtoon_data.to_csv('./crawling_data/kakao_finished.csv', encoding='utf-8-sig')